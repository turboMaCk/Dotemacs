...
Custom useful functions (mostly binded to shortcuts)
...
#+BEGIN_SRC emacs-lisp
  (require 'nyan-mode)
  (defun init-nyan-mode-sweetness ()
...
Elm is simple ML like language with great ecosystem. This is my go-to default when it goes to web app development.
