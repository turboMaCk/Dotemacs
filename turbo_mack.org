...
#+BEGIN_SRC emacs-lisp
  (load
       (expand-file-name "theme/twilight.el"
...
*** Typescript
    ...
    Please make sure both typescript and
...
*** Haskell
    ...
    - [[https://github.com/chrisdone/hindent][hindent-mode]] takes care of formatting ~stack install hindent~.
    - [[https://github.com/marcotmarcot/hasktags][hasktags]] is tool for creating tag files ~stack install hasktags~.
    - [[https://github.com/jaspervdj/stylish-haskell][stylish-haskell]] is another code formatting tool ~stack install stylish-haskell~.
...
**** TODO WriteGood mode
     Turn on writegood as in org-mode.
